...
from prepare_data import prepare_compas,prepare_IBM_adult, prepare_law, prepare_food
...
if __name__ == '__main__':
    ...
    if sys.argv[1] == 'adult':
        ...
        dataA,dataY,dataX,perm = prepare_food(sys.argv[3])
        dataset = 'food'
        sanitarian_color = sys.argv[3]
    else:
    ...
    if sys.argv[1] == 'food':
        filename_tr = "results/fairll_{}_{}_{:.3f}_{}_tr.csv".format(dataset,sanitarian_color,C,criteria)
        filename_ts = "results/fairll_{}_{}_{:.3f}_{}_ts.csv".format(dataset,sanitarian_color,C,criteria)
    else:
