...
for (window_split in test_window_range) {
    ...
    baseline_csv_path <- paste("../baselines/fair-classification/food_scores/zafar_scores_",window_split,"_",zafar_c_threshold,".csv", sep = "")
    ...
    cat(mean(sanitarian_dat[criticalFound == 1, date_difference]), ", ")
    ...
    write.csv(newdf, paste("baseline_zafar/",window_split,"_",zafar_c_threshold,"_window_geo.csv", sep = ""), row.names=FALSE)
