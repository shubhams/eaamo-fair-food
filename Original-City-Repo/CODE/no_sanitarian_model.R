...
while(start_date <= window_end_date) {
    ...
    ## Save Results
    saveRDS(dat, paste("no_sanitarians_data/30_dat_ns_",ctr,".Rds", sep = ""))
    # saveRDS(xmat, "no_sanitarians_data/30_xmat_ns.Rds")               # ZIP_CODE and Inspector are missing hm 
    # saveRDS(mm, "no_sanitarians_data/30_modelmatrix_ns.Rds")
    # saveRDS(coef, "no_sanitarians_data/30_coef_ns.Rds")
    #saveRDS(inspCoef, "data/30_inspCoef_ns.Rds")
    # saveRDS(model, "no_sanitarians_data/30_model_ns.Rds")
