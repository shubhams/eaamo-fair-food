...
# renaming columns
names(foodInspect)[names(foodInspect) == 'Inspection ID'] <- 'Inspection_ID'
names(foodInspect)[names(foodInspect) == 'DBA Name'] <- 'DBA_Name'
names(foodInspect)[names(foodInspect) == 'AKA Name'] <- 'AKA_Name'
names(foodInspect)[names(foodInspect) == 'License #'] <- 'License'
names(foodInspect)[names(foodInspect) == 'Facility Type'] <- 'Facility_Type'
names(foodInspect)[names(foodInspect) == 'Risk'] <- 'Risk'
names(foodInspect)[names(foodInspect) == 'Address'] <- 'Address'
names(foodInspect)[names(foodInspect) == 'City'] <- 'City'
names(foodInspect)[names(foodInspect) == 'State'] <- 'State'
names(foodInspect)[names(foodInspect) == 'Zip'] <- 'Zip'
names(foodInspect)[names(foodInspect) == 'Inspection Date'] <- 'Inspection_Date'
names(foodInspect)[names(foodInspect) == 'Inspection Type'] <- 'Inspection_Type'
names(foodInspect)[names(foodInspect) == 'Results'] <- 'Results'
names(foodInspect)[names(foodInspect) == 'Violations'] <- 'Violations'
names(foodInspect)[names(foodInspect) == 'Latitude'] <- 'Latitude'
names(foodInspect)[names(foodInspect) == 'Longitude'] <- 'Longitude'
names(foodInspect)[names(foodInspect) == 'Location'] <- 'Location'
names(foodInspect)[names(foodInspect) == 'Block Group Geo ID'] <- 'Block_Group_Geo_ID'
names(foodInspect)[names(foodInspect) == 'American Indian'] <- 'American_Indian'
