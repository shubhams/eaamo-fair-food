...
for (window_split in test_window_range) {
    ...
    baseline_csv_path <- paste("../baselines/fairness_experiments/food/scores/krishnaswamy_preds_",window_split,".csv", sep = "")
    ...
    write.csv(newdf, paste("baseline_krishnaswamy/","preds_",window_split,"_window_geo.csv", sep = ""), row.names=FALSE)
