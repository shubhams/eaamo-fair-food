...
for (C in C_list) {
    for (window_split in test_window_range) {
        ...
        sep = "")
        baseline_csv_path <- paste("../baselines/fair-logloss-classification/results/scores_",window_split,"_",criteria,"_",
                                   majority,"_",C,".csv", sep = "")
        ...
        write.csv(newdf, paste("baseline_test_window/",window_split,"_window_",criteria,"_",
                               majority,"_",C,"_geo.csv", sep = ""), row.names=FALSE)
    }
}
