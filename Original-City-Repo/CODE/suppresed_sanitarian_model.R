...
while(start_date <= window_end_date) {
    ...
    # Save Results
    saveRDS(dat, paste("suppressed_sanitarian_features/30_dat_",ctr,".Rds", sep = ""))
...
# 
# # Save Results
# saveRDS(dat, "moving_test_window/30_dat.Rds")
# saveRDS(xmat, "moving_test_window/30_xmat.Rds")
# saveRDS(mm, "moving_test_window/30_modelmatrix.Rds")
# saveRDS(coef, "moving_test_window/30_coef.Rds")
# saveRDS(inspCoef, "moving_test_window/30_inspCoef.Rds")
# saveRDS(model, "moving_test_window/30_model.Rds")
# saveRDS(model_eval, "moving_test_window/30_model_eval.Rds")
